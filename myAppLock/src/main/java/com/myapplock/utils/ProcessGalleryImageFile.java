...
public class ProcessGalleryImageFile extends AsyncTask<Void, Void, Bitmap> {
    ...
    public ProcessGalleryImageFile(ImageView photoHolder, TextView durationHolder, String filePath, MediaType type) {
    ...
    protected Bitmap doInBackground(Void... params) {
        ...
        if (type == MediaType.PHOTO) {
            try {
                ...
                Log.e(ProcessGalleryImageFile.class.getSimpleName(), ""+e);
            }
            if (bmp == null) {
                try {
    ...
    protected void onPostExecute(Bitmap result) {
        ...
        if (type == MediaType.PHOTO) {
           // durationHolder.setVisibility(View.GONE); null
    ...
    public boolean equals(Object o) {
        if (o == null || !(o instanceof ProcessGalleryImageFile)) return false;
        ProcessGalleryImageFile file = (ProcessGalleryImageFile) o;
