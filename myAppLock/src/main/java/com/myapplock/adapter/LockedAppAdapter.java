...
public class LockedAppAdapter extends RecyclerView.Adapter<LockedAppAdapter.CustumViewHolder>
{
    ...
    public LockedAppAdapter(Context context, ArrayList<AppItems> ModelArrayList, int pListType)
    {
